                ...
                <div class="title d-flex flex-wrap justify-content-between">
                  <div class="w-100">
                    <h6 class="text-medium mb-10">Contenido Banner</h6>
                      ...
                      <div class="card-style mb-30">
                      <form role="form"  name="fe" action="<?php echo RUTA_URL;?>/Principales/eliminarCard/<?php echo $datos['cont']->id; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <input tabindex="3" type="submit" name="editar1" class="main-btn primary-btn rounded-md btn-hover" value="Eliminar">
                        </form>
                      </div>
