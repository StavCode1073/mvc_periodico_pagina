...
<body>
	<div class="pt-3 alto-baner">
		 <div>
		 	<img src="<?php echo RUTA_URL;?>/img/logos_izq.gif" class="rounded mx-auto d-block" alt="...">
		 </div>
	</div>
	<div class="colordiv" style="background-color: #3e3f3a;">
		<div class="container">
