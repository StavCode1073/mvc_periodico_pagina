        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="<?php echo RUTA_URL; ?>/Principales/dashboard" class="active"> Admin website </a>
              </li>
              <!-- <li>
...
<!-- paginas -->
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Editar páginas</span>
            </a>
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="<?php echo RUTA_URL; ?>/Principales/editarinfoinst">Infoamción institucional </a>
              </li>
              <li>
                <a href="<?php echo RUTA_URL; ?>/Principales/editarServicio">Servicios </a>
              </li>
              <li>
                <a  href="<?php echo RUTA_URL; ?>/Principales/tabPrecios">Tabulador de precios </a>
              </li>
              <li>
                <a  href="<?php echo RUTA_URL; ?>/Principales/dondePublicar">Donde publicar </a>
              </li>
              <li>
                <a  href="<?php echo RUTA_URL; ?>/Principales/editContacto">Contacto </a>
              </li>
              <li>
                <a  href="<?php echo RUTA_URL; ?>/Principales/editarSuscripciones">Suscripciones </a>
              </li>
            </ul>
          </li>
<!-- secciones principales -->
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Editar secciones principales</span>
            </a>
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              <li>
                <a href="<?php echo RUTA_URL; ?>/Principales/inicioedit">Página incial </a>
              </li>
              <li>
                <a href="<?php echo RUTA_URL; ?>/Principales/pie">Infomación pie de página</a>
              </li>
            </ul>
          </li>
